...
class String(str, Type):
    ...
    def __init__(self, value):
        ...
        self.vars = {
            "length": len(self),
            "split": self.split,
            "slice": lambda start=0, end=None, step=1: self[
...
class Array(Type, list):
    ...
    def __init__(self, value):
        ...
        self.vars = {
            ...
            "reduce": self._reduce,
            "slice": lambda start=0, end=None, step=1: Array(
                self.value[start:end:step]
            ),
            "sort": self._sort,
...
class Set(Type, list):
    ...
    def __init__(self, value):
        ...
        self.vars = {
            ...
            "reverse": self._reverse,
            "filter": self._filter,
            "slice": lambda start=0, end=None, step=1: Set(self.value[start:end:step]),
            # methods and attributes here
        }
